...
int options3(int *ptr3, int *ptr_correct2, int *ptr_wrong2);
int options4(int *ptr4);
int options5(int *ptr5,int *ptr_correct,int *ptr_wrong);
...
int  main()
{
    ...
    static struct code_counter count;
